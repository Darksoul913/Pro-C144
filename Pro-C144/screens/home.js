...
export default class HomeScreen extends React.Component{
    ...
    getArticles =()=>{
        const url = "https://27ed-122-171-19-54.ngrok.io/get-articles";
    ...
    likeArticles =()=>{
        const url = "https://27ed-122-171-19-54.ngrok.io/liked-articles";
    ...
    dislikeArticles =()=>{
        const url = "https://27ed-122-171-19-54.ngrok.io/disliked-articles";
        axios.post(url).then(response=>{
            this.getArticles();
        })
    }
